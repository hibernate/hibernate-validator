...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter02/typeargument/custom/GearBoxUnwrapper.java[tags=include]
----
