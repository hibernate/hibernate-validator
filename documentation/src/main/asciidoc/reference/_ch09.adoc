...
* `bindProperties(T, PasswordContext)` -- binds additional properties that rules can read
...
[[example-password-policy-class-level-usage]]
.Registering and using the class-level validator
====
[source, java, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter09/PasswordPolicyTest.java[tags=classLevelUsage]
----
====
