...
Hibernate Validator uses the `AccessorFactory` from Hibernate Accessor library to access bean property
...
ValidatorFactory validatorFactory = Validation.byProvider( HibernateValidator.class )
        .configure()
        .accessorFactory( ByteBuddyAccessorFactory.factory( MethodHandles.lookup() ) )
...
ValidatorFactory validatorFactory = Validation.byProvider( HibernateValidator.class )
        .configure()
        .accessorFactory( AsmAccessorFactory.factory( MethodHandles.lookup() ) )
        .buildValidatorFactory();
----
====
...
[NOTE]
====
The built-in bytecode-based factories (`AsmAccessorFactory`, `ByteBuddyAccessorFactory`)
