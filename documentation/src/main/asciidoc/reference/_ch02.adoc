...
`@ISSN`:: Checks that the annotated character sequence is a valid https://en.wikipedia.org/wiki/International_Standard_Serial_Number[ISSN]. `type` determines the type of ISSN. The default is ISSN-13.
	Supported data types::: `CharSequence`
	Hibernate metadata impact::: None
