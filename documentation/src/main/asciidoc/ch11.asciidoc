...
http://beanvalidation.org/2.0/spec/index.html#constraintdeclarationvalidationprocess-methodlevelconstraints-inheritance[section 5.6.5]
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/constraintapi/ConstraintApiTest.java[tags=nestedContainerElementConstraint]
----
====
...
to all constraint violations created by this `isValid()` invocation. This includes the default
