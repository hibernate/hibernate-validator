...
==== Constraint definitions via programmatic constraint declaration API
...
[[example-using-constraint-definition-api]]
.Using the programmatic constraint declaration API to register constraint definitions
========
[source, JAVA, indent=0]
----
