...
`org.hibernate.validator.spi.time`::
			An SPI for customizing the retrieval of the current time when validating `@Future` and `@Past`, see <<section-time-provider>>.
`org.hibernate.validator.valuehandling`, `org.hibernate.validator.spi.valuehandling`::
			Classes related to the processing of values prior to thei validation, see <<section-value-handling>>.
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/relaxation/RelaxationTest.java[tags=testRelaxation]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/booleancomposition/PatternOrSize.java[tags=include]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/context/MyFutureValidator.java[tags=include]
----
====
+
[WARNING]
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/valuehandling/Person.java[tags=javafxUnwrapValidatedValue]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/valuehandling/PropertyValueUnwrapper.java[tags=include]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/valuehandling/UnwrapValidatedValueTest.java[tags=unwrapValidated]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/valuehandling/Person.java[tags=optional]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/valuehandling/Person.java[tags=javafx]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/valuehandling/graph/Container.java[tags=include]
----

[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/valuehandling/graph/Person.java[tags=include]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/classloading/ClassLoadingTest.java[tags=setupValidator]
----
====
...
[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/timeprovider/CustomTimeProvider.java[tags=include]
----

[source, JAVA, indent=0]
----
include::{sourcedir}/org/hibernate/validator/referenceguide/chapter11/timeprovider/CustomTimeProviderTest.java[tags=setupValidator]
----
====
