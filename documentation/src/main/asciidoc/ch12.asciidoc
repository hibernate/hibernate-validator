...
hibernate-validator-annotation-processor-{hvVersion}.jar using the "processorpath" option as shown in
...
* http://opensource.atlassian.com/projects/hibernate/browse/HV-308[HV-308]: Additional validators
registered for a constraint
http://docs.jboss.org/hibernate/stable/validator/reference/en/html_single/#d0e1957[using XML] are
not evaluated by the annotation processor.

* Sometimes custom constraints can't be
http://opensource.atlassian.com/projects/hibernate/browse/HV-293[properly evaluated] when
