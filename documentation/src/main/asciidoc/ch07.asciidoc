...
[source, XML, indent=0]
----
include::{resourcesdir}/org/hibernate/validator/referenceguide/chapter07/validation.xml[]
----
====
...
[source, XML, indent=0]
----
include::{resourcesdir}/org/hibernate/validator/referenceguide/chapter07/rental-car-mapping.xml[]
----
====
...
[source, XML, indent=0]
----
include::{resourcesdir}/org/hibernate/validator/referenceguide/chapter07/rental-station-mapping.xml[]
----
====
