...
returns an instance of the {bvApiDocsUrl}?javax/validation/metadata/BeanDescriptor.html[`BeanDescriptor`] interface. Using this
...
The interface
{bvApiDocsUrl}?javax/validation/metadata/PropertyDescriptor.html[`PropertyDescriptor`] represents one given property of a
...
{bvApiDocsUrl}?javax/validation/metadata/MethodDescriptor.html[`MethodDescriptor`]
{bvApiDocsUrl}?javax/validation/metadata/ConstructorDescriptor.html[`ConstructorDescriptor`], respectively.
...
The {bvApiDocsUrl}?javax/validation/metadata/ElementDescriptor.html[`ElementDiscriptor`]
...
{bvApiDocsUrl}?javax/validation//metadata/GroupConversionDescriptor.html[`GroupConversionDescriptor`]
...
{bvApiDocsUrl}?javax/validation/metadata/ConstraintDescriptor.html[`ConstraintDescriptor`]
