...
public class TypeNames {
	...
	public static class HibernateValidatorTypes {
		...
		public static final String CONTAINS = ORG_HIBERNATE_VALIDATOR_CONSTRAINTS + ".Contains";
		...
		public static final String URI = ORG_HIBERNATE_VALIDATOR_CONSTRAINTS + ".URI";
