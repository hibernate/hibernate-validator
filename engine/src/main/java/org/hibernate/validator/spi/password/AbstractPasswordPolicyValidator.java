 ...
 * bind additional properties (such as a username) via {@link #bindProperties(Object, PasswordContext)}.
 ...
 *
 *     @Override
 *     protected void bindProperties(UserDetails bean, PasswordContext context) {
...
public abstract class AbstractPasswordPolicyValidator<T>
	 ...
	 *
	 * @param bean the bean instance
	 * @param context the password context to bind properties to
	 */
	protected void bindProperties(T bean, PasswordContext context) {
	}
	...
	public boolean isValid(T value, ConstraintValidatorContext context) {
		...
		PasswordContext passwordContext = PasswordPolicyValidationHelper.createContext( password );
		bindProperties( value, passwordContext );
