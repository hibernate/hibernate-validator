...
/**
 * Builder for constraints information. Creates a constraint based on a set of given values.
 *
...
class ConstraintTypeStaxBuilder extends AbstractStaxBuilder {
	...
	private final ConstrainParameterStaxBuilder constrainParameterStaxBuilder;
	...
	ConstraintTypeStaxBuilder(
		...
		this.constrainParameterStaxBuilder = new ConstrainParameterStaxBuilder( classLoadingHelper, defaultPackageStaxBuilder );
	...
	private static class ConstrainParameterStaxBuilder extends AnnotationParameterStaxBuilder {

		private static final String ELEMENT_QNAME_LOCAL_PART = "element";
		private static final QName NAME_QNAME = new QName( "name" );

		public ConstrainParameterStaxBuilder(ClassLoadingHelper classLoadingHelper, DefaultPackageStaxBuilder defaultPackageStaxBuilder) {
