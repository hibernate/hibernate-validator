...
import static org.hibernate.validator.internal.metadata.core.BuiltinConstraint.ORG_HIBERNATE_VALIDATOR_CONSTRAINTS_ISSN;
...
public abstract class ConstraintHelper {
	...
	protected Map<Class<? extends Annotation>, List<? extends ConstraintValidatorDescriptor<?>>> resolve(Set<BuiltinConstraint> enabledBuiltinConstraints) {
		...
		if ( enabledBuiltinConstraints.contains( ORG_HIBERNATE_VALIDATOR_CONSTRAINTS_DATE_TIME_FORMAT ) ) {
			putBuiltinConstraint( tmpConstraints, DateTimeFormat.class, DateTimeFormatValidator.class );
		}
		...
		if ( enabledBuiltinConstraints.contains( ORG_HIBERNATE_VALIDATOR_CONSTRAINTS_ISSN ) ) {
			putBuiltinConstraint( tmpConstraints, ISSN.class, ISSNValidator.class );
		}
