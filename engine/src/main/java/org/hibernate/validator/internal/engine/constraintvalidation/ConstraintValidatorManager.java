...
public class ConstraintValidatorManager {
	 ...
	 */
	static ConstraintValidator<?, ?> DUMMY_CONSTRAINT_VALIDATOR = (ConstraintValidator<Null, Object>) (value, context) -> false;
	...
	/**
	 * @see ConstraintValidatorManager#getInitializedValidator(Type, ConstraintDescriptorImpl, ConstraintValidatorFactory, HibernateConstraintValidatorInitializationContext)
	 */
	public <A extends Annotation> ConstraintValidator<A, ?> getInitializedValidator(
		...
		return getInitializedValidator(
				validatedValueType, descriptor, constraintFactory,
				HibernateConstraintValidatorInitializationContextImpl.dummyContext()
		);
	}
