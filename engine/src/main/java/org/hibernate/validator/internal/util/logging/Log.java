...
public interface Log extends BasicLogger {
	...
	@LogMessage(level = INFO)
	@Message(id = 242, value = "Using %s as getter property matcher.")
	...
	@Message(id = 243, value = "Unable to instantiate getter property matcher class %s.")
	...
	@LogMessage(level = WARN)
	@Message(id = 244, value = "Note that constraint mappings will be build with %s getter property matcher.")
	...
	@LogMessage(level = WARN)
	@Message(id = 245, value = "As no getter property matcher was defined for current configuration a default one will be used.")
