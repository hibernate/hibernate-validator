...
public interface Log extends BasicLogger {
	...
	@Message(id = 265, value = "Inconsistent fail fast on property violation mode configuration. It is enabled via programmatic API, but explicitly disabled via properties.")
