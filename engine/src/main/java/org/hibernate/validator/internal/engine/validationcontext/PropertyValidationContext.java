 ...
 * @author Marko Bekhta
 */
class PropertyValidationContext<T> extends AbstractValidationContext {
	...
	@Override
	public boolean canProcess(MetaConstraint metaConstraint) {
	...
	@Override
	protected ConstraintViolation createConstraintViolation(
	...
	public String toString() {
		final StringBuilder sb = new StringBuilder( "PropertyValidationContext{" );
