...
enum BuiltinConstraint {
	...
	ORG_HIBERNATE_VALIDATOR_CONSTRAINTS_PY_RUC( "org.hibernate.validator.constraints.py.RUC" ),
	...
	ORG_HIBERNATE_VALIDATOR_CONSTRAINTS_PASSWORD_POLICY( "org.hibernate.validator.constraints.PasswordPolicy" ),
