...
public class ConfigurationImpl implements HibernateValidatorConfiguration, ConfigurationState {
	...
	private final ConstraintValidatorLocator defaultConstraintValidatorLocator;
	...
	private ConfigurationImpl() {
		...
		this.defaultConstraintValidatorLocator = new ServiceLoaderBasedConstraintValidatorLocator(
				typeResolutionHelper
		);
		this.addConstraintValidatorLocator( defaultConstraintValidatorLocator );
	}
	...
	@Override
	public ConstraintValidatorLocator getDefaultConstraintValidatorLocator() {
		return defaultConstraintValidatorLocator;
	}

	public Set<ConstraintValidatorLocator> getConstraintValidatorLocator() {
		return validationBootstrapParameters.getConstraintValidatorLocators();
	}

	@Override
	public HibernateValidatorConfiguration addConstraintValidatorLocator(ConstraintValidatorLocator locator) {
		Contracts.assertNotNull( locator, MESSAGES.parameterMustNotBeNull( "locator" ) );
		validationBootstrapParameters.addConstraintValidatorLocator( locator );
