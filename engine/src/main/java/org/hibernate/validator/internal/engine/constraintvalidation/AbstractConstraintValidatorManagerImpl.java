...
public abstract class AbstractConstraintValidatorManagerImpl implements ConstraintValidatorManager {
	 ...
	 */
	protected <A extends Annotation> ConstraintValidatorDescriptor<A> findMatchingValidatorDescriptor(ConstraintDescriptorImpl<A> descriptor, Type validatedValueType) {
	...
	protected <A extends Annotation> List<Type> findSuitableValidatorTypes(Type type, Iterable<Type> availableValidatorTypes) {
	...
	protected <A extends Annotation> void initializeValidator(
	 ...
	 */
	protected void resolveAssignableTypes(List<Type> assignableTypes) {
