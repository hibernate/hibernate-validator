 ...
 */
abstract class JsonConstraintMappingContextImplBase extends JsonConstraintContextImplBase {

	private final Set<ConfiguredConstraint<?>> constraints;

	JsonConstraintMappingContextImplBase(JsonConstraintMappingImpl mapping) {
		super( mapping );
	...
	protected JsonConstraintMappingImpl getConstraintMapping() {
		return mapping;
	}
