 ...
 */
public class TypeArgumentDescriptorImpl extends ElementDescriptorImpl implements ElementDescriptor, CascadableDescriptor {
	private final boolean cascaded;
	private final String property;
	private final Set<GroupConversionDescriptor> groupConversions;

	public TypeArgumentDescriptorImpl(Type returnType,
								  String propertyName,
	...
	public String toString() {
		...
		sb.append( "TypeArgumentDescriptorImpl" );
