...
/**
 * Top level builder for constraint mappings. Reads whole mapping file and builds
 * constraint definitions defined in it as well as list of constrained elements per bean.
 *
 * @author Marko Bekhta
 */
