...
public class ConstraintLocationTest {
	...
	public void two_constraint_locations_for_the_same_member_should_be_equal() throws Exception {
		...
		ConstraintLocation location1 = ConstraintLocation.forGetter( new JavaBeanGetter( ReflectionJavaBeanPropertyAccessorFactory.INSTANCE, getter ) );
		ConstraintLocation location2 = ConstraintLocation.forGetter( new JavaBeanGetter( ReflectionJavaBeanPropertyAccessorFactory.INSTANCE, getter ) );
