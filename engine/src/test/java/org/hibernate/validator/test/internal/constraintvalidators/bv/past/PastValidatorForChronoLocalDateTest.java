...
public class PastValidatorForChronoLocalDateTest {
	...
	public void testIsValidForLocalDate() {
		...
		assertTrue( constraint.isValid( past, getConstraintValidatorContext() ), "Past LocalDate '" + past + "' fails validation.");
		assertFalse( constraint.isValid( future, getConstraintValidatorContext() ), "Future LocalDate '" + future + "' validated as past.");
	}
	...
	public void testIsValidForJapaneseDate() {
		...
		assertTrue( constraint.isValid( past, getConstraintValidatorContext() ), "Past JapaneseDate '" + past + "' fails validation.");
		assertFalse( constraint.isValid( future, getConstraintValidatorContext() ), "Future JapaneseDate '" + future + "' validated as past.");
	}
	...
	public void testIsValidForHijrahDate() {
		...
		assertTrue( constraint.isValid( past, getConstraintValidatorContext() ), "Past HijrahDate '" + past + "' fails validation.");
		assertFalse( constraint.isValid( future, getConstraintValidatorContext() ), "Future HijrahDate '" + future + "' validated as past.");
	}
	...
	public void testIsValidForMinguoDate() {
		...
		assertTrue( constraint.isValid( past, getConstraintValidatorContext() ), "Past MinguoDate '" + past + "' fails validation.");
		assertFalse( constraint.isValid( future, getConstraintValidatorContext() ), "Future MinguoDate '" + future + "' validated as past.");
	}
	...
	public void testIsValidForThaiBuddhistDate() {
		...
		assertTrue( constraint.isValid( past, getConstraintValidatorContext() ), "Past ThaiBuddhistDate '" + past + "' fails validation.");
		assertFalse( constraint.isValid( future, getConstraintValidatorContext() ), "Future ThaiBuddhistDate '" + future + "' validated as past.");
	}
}
