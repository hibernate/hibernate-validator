...
/**
 * Tests for MessageDescriptorParser.
 *
...
public class MessageDescriptorParserTest {
	...
	public void testGettingInterpolatedMessageBeforeParsingIsComplete() {
	...
	public void testInvalidMessageDescriptor() throws Exception {
		MessageDescriptorParser descriptorParser = MessageDescriptorParser.forParameter( "#{foo  {}" );
		descriptorParser.hasMoreInterpolationTerms();
	}

	@Test(expectedExceptions = MessageDescriptorFormatException.class)
	public void testEscapeOfNonMetaCharacterThrowsException() throws Exception {
		MessageDescriptorParser descriptorParser = MessageDescriptorParser.forParameter( "\\z" );
		descriptorParser.hasMoreInterpolationTerms();
	}
	...
	@Test(expectedExceptions = MessageDescriptorFormatException.class)
	public void testTermWithoutBraceBraceThrowsException() throws Exception {
		MessageDescriptorParser descriptorParser = MessageDescriptorParser.forParameter( "{foo" );
		descriptorParser.hasMoreInterpolationTerms();
	}
	...
	@Test
	public void testEscapedExpressionLanguageLiteral() throws Exception {
		MessageDescriptorParser descriptorParser = MessageDescriptorParser.forParameter( "The price is US\\$ {value}" );
		assertSingleReplacement( descriptorParser, "{value}", "100", "The price is US\\$ 100" );
	}
