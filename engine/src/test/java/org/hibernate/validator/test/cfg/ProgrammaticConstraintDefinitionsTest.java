...
public class ProgrammaticConstraintDefinitionsTest {
	...
	public void countrySpecificProgrammaticDefinition() {
		...
		doProgrammaticTest( KorRRN.class, new KorRRNDef(), "030205-3000000", "039999-3000000", "invalid Korean resident registration number (KorRRN)" );
		doProgrammaticTest( KorRRN.class, new KorRRNDef(), "010101-4000000", "010101-5000000", "invalid Korean resident registration number (KorRRN)" );
	}
