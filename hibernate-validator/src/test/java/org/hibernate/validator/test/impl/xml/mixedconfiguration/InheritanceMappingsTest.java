...
*/
package org.hibernate.validator.test.impl.xml.mixedconfiguration;
...
import org.hibernate.validator.test.impl.xml.mixedconfiguration.annotation.Competition;
import org.hibernate.validator.test.impl.xml.mixedconfiguration.annotation.Fixture;
import org.hibernate.validator.test.impl.xml.mixedconfiguration.annotation.PersonCompetition;
import org.hibernate.validator.test.impl.xml.mixedconfiguration.annotation.TeamCompetition;
...
public class InheritanceMappingsTest {
	...
	public void customConfigurationExplicitXmlDefinition() {
		validateXmlDefinedFixture(
				new org.hibernate.validator.test.impl.xml.mixedconfiguration.xml.PersonCompetition(),
	...
	public void customConfigurationNoExplicitXmlDefinition() {
		validateXmlDefinedFixture(
				new org.hibernate.validator.test.impl.xml.mixedconfiguration.xml.TeamCompetition(),
				configure( "xml-mappings.xml" )
		);
	}
	...
	private void validateXmlDefinedFixture(org.hibernate.validator.test.impl.xml.mixedconfiguration.xml.Competition competition,
										   Validator validator) {
		org.hibernate.validator.test.impl.xml.mixedconfiguration.xml.Fixture fixture = new org.hibernate.validator.test.impl.xml.mixedconfiguration.xml.Fixture();
		fixture.setCompetition( competition );
		validateFixture( fixture, validator );
	}
}
