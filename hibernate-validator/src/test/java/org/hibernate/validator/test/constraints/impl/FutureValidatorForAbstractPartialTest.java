 ...
 * @author Kevin Pollet
 */
public class FutureValidatorForAbstractPartialTest {

	private static FutureValidatorForAbstractPartial validator;

	@BeforeClass
	public static void init() {
		validator = new FutureValidatorForAbstractPartial();
	}
