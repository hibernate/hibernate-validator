...
public abstract class MetaConstraint<A extends Annotation> {
	...
	public boolean equals(Object o) {
		...
		if ( constraintTree != null ? !constraintTree.equals( that.constraintTree ) : that.constraintTree != null ) {
			return false;
		}
	...
	@Override
	public int hashCode() {
		int result = constraintTree != null ? constraintTree.hashCode() : 0;
	...
	public String toString() {
		return "MetaConstraint [constraintType=" + constraintDescriptor.getAnnotation().annotationType().getName()  + ", location="
				+ location + "]";
	}
}
