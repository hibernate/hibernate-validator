...
public final class ReflectionHelper {
	...
	/**
	 * Returns the field with the specified name or {@code null} if it does not exist.
	 *
	 * @param clazz The class to check
	 * @param fieldName The field name
	 *
	 * @return Returns the field with the specified name or {@code null} if it does not exist.
	 */
